...
const projects = [
  ...
  },
  {
    name: "Pokemon SQL AI",
    description:
      "This app allows users to explore and interact with Pokémon data through a sleek interface. Leveraging OpenAI's natural language capabilities, users can ask questions, search, and discover Pokémon details.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
